package com.cyl.scaffold.core.aspect;

import com.cyl.scaffold.core.annotation.DataSourceType;
...
public class DataSourceAspect {
    ...
    @Pointcut("@annotation(com.cyl.scaffold.core.annotation.DataSourceType) || @within(com.cyl.scaffold.core.annotation.DataSourceType)")
